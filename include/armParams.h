...
#define CLAW_Y_PHYSICAL_ANGLE 90
...
enum ArmOperationResult {
    ...
    ERROR_POINT_UNREACHABLE = -11,
    ERROR_SUM_OF_ANGLES_ABOVE_MAX = -12,
    ERROR_COMMAND_QUEUE_IS_FULL = -13,
    ERROR_COMMAND_QUEUE_ITEM_IS_INVALID = -14, 
};
